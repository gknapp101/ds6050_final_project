...
inner zips of OpenSARShip_1.zip.

Key structural difference from OpenSARShip_2: all files inside each inner zip are
nested under a scene-named subdirectory (e.g. {scene}/Ship.xml, {scene}/Patch_Uint8/).

Row order matches the sorted Patch_Uint8 file order within each scene, with scenes
processed in sorted zip-name order.
...
AIS_SHIP_TYPES: dict[int, str] = {
    ...
    25: "Wing in Ground - Reserved", 26: "Wing in Ground - Reserved",
    27: "Wing in Ground - Reserved", 28: "Wing in Ground - Reserved",
    ...
    45: "High speed craft - Reserved", 46: "High speed craft - Reserved",
    47: "High speed craft - Reserved", 48: "High speed craft - Reserved",
    ...
    65: "Passenger - Reserved", 66: "Passenger - Reserved",
    67: "Passenger - Reserved", 68: "Passenger - Reserved",
    ...
    75: "Cargo - Reserved", 76: "Cargo - Reserved",
    77: "Cargo - Reserved", 78: "Cargo - Reserved",
    ...
    85: "Tanker - Reserved", 86: "Tanker - Reserved",
    87: "Tanker - Reserved", 88: "Tanker - Reserved",
    ...
    95: "Other Type - Reserved", 96: "Other Type - Reserved",
    97: "Other Type - Reserved", 98: "Other Type - Reserved",
...
def main():
    ...
    for zip_path in inner_zips:
        ...
        # Ship.xml is nested: {scene_name}/Ship.xml
        ship_xml_path = next((f for f in all_files if f.endswith("/Ship.xml") or f == "Ship.xml"), None)
        if not ship_xml_path:
            print(f"  WARNING: no Ship.xml in {scene}, skipping")
            continue
        coord_to_type = parse_xml_ship_types(inner.read(ship_xml_path))

        # Patch_Uint8 files are nested: {scene_name}/Patch_Uint8/Visual_...tif
        patch_files = sorted(
        ...
        for fpath in patch_files:
            ...
            path = f"data/classification/OpenSARShip_1/{scene_name}/Patch_Uint8/{fname}"
            rows.append({
                "path": path,
